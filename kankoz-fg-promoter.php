 ...
 *
 * @link              https://wordpress.org/plugins/wp-group-promoter
 * @since             1.0.0
 * @package           Kankoz_Fg_Promoter
 *
 * @wordpress-plugin
 * Plugin Name: 	  WP Group Promoter (Premium)
 * Plugin URI:        https://grouppromoter.com
 * Description:       This Group Plugin lets people join your Facebook group from a link on your web page, widget or via shortcode.
 * Version:           1.0.8
 * Author:            Jamiu Oloyede
 * Author URI:        https://wordpress.org/plugins/wp-group-promoter
 * License:           GPL-2.0+
